...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var resultChart = samples.filter(sampleObj => sampleObj.id == sample);
    ...
    var barLayout = {
     title: "Top 10 Bacteria in Sample Belly Buttons",
    ...
    var gaugeLayout = {width: 400, height: 450, margin:{t:0, b:0}};
